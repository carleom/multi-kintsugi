...
hi("@operator", { fg = c.operator })
hi("@operator.typescript", { fg = c.operator })
hi("@operator.tsx", { fg = c.operator })
hi("@operator.svelte", { fg = c.operator })
hi("@string", { fg = c.string })
...
hi("@variable.member.typescript", { fg = c.syntax })
hi("@variable.member.tsx", { fg = c.syntax })
hi("@variable.member.svelte", { fg = c.syntax })
...
hi("@lsp.type.property.typescript", { fg = c.syntax })
hi("@lsp.type.property.tsx", { fg = c.syntax })
hi("@lsp.type.property.svelte", { fg = c.syntax })
...
hi("@lsp.typemod.property.defaultLibrary", { fg = c.symbol })
hi("@lsp.typemod.variable.defaultLibrary", { fg = c.storage, bold = true })
hi("@lsp.typemod.variable.readonly", { fg = c.syntax })
