...
hi("@variable.member.typescript", { fg = c.symbol })
hi("@variable.member.tsx", { fg = c.symbol })
hi("@variable.member.svelte", { fg = c.symbol })
...
hi("@lsp.type.property.typescript", { fg = c.symbol })
hi("@lsp.type.property.tsx", { fg = c.symbol })
hi("@lsp.type.property.svelte", { fg = c.symbol })
