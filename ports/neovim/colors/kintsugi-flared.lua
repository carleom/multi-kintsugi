...
hi("TSKeyword", { fg = c.storage, bold = true })
hi("TSKeywordFunction", { fg = c.storage, bold = true })
hi("TSKeywordReturn", { fg = c.keyword, bold = true })
hi("TSVariableBuiltin", { fg = c.storage, bold = true })
hi("TSTypeBuiltin", { fg = c.operator })
hi("TSConstructor", { fg = c.storage, bold = true })

hi("typescriptVariableDeclaration", { fg = c.storage, bold = true })
hi("typescriptVariable", { fg = c.storage, bold = true })
hi("typescriptFuncKeyword", { fg = c.storage, bold = true })
hi("typescriptExport", { fg = c.keyword, bold = true })
hi("typescriptImport", { fg = c.keyword, bold = true })
hi("javascriptVariableDeclaration", { fg = c.storage, bold = true })
hi("javascriptVariable", { fg = c.storage, bold = true })
hi("javascriptFuncKeyword", { fg = c.storage, bold = true })
